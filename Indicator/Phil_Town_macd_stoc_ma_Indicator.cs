...
namespace AgenaTrader.UserCode
{
	...
	public class Phil_Town_macd_stoc_ma_Indicator : UserIndicator
	{
		...
		{
			Add(new Plot(Color.FromKnownColor(KnownColor.Orange), "Phil_Town_macd_stoc_ema_Plot"));
...
namespace AgenaTrader.UserCode
{
	...
	{
		/// <summary>
		/// Phil Town MACD Stocastic EMA.
		/// </summary>
		public Phil_Town_macd_stoc_ma_Indicator Phil_Town_macd_stoc_ma_Indicator()
        {
			return Phil_Town_macd_stoc_ma_Indicator(InSeries);
		}

		/// <summary>
		/// Phil Town MACD Stocastic EMA.
		/// </summary>
		public Phil_Town_macd_stoc_ma_Indicator Phil_Town_macd_stoc_ma_Indicator(IDataSeries input)
		{
			var indicator = CachedCalculationUnits.GetCachedIndicator<Phil_Town_macd_stoc_ma_Indicator>(input);

			if (indicator != null)
				return indicator;

			indicator = new Phil_Town_macd_stoc_ma_Indicator
						{
	...
	public partial class UserStrategy
	{
		...
		public Phil_Town_macd_stoc_ma_Indicator Phil_Town_macd_stoc_ma_Indicator()
		{
			return LeadIndicator.Phil_Town_macd_stoc_ma_Indicator(InSeries);
		}
		...
		public Phil_Town_macd_stoc_ma_Indicator Phil_Town_macd_stoc_ma_Indicator(IDataSeries input)
		{
			...
			return LeadIndicator.Phil_Town_macd_stoc_ma_Indicator(input);
		}
	}
